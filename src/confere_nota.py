...
CHECAGENS = [
    ...
    ("bias sem WASP-18 b (os quatro)", "3.4", r"the most precise of them — left ([−-]\d\.\d\d) ± \d\.\d\d min", "3.4/hj[IW22 (linear, os 4)]",
     lambda v: f"{v['sem_WASP18']:.2f}"),
    ...
    # rodada vinte: a amostra de calibradores alargada
    ("calibradores: candidatos", "3.4", r"The candidates are the (\d+) transiting planets", "3.4/calibradores_expandido",
     lambda v: str(v["n_candidatos"])),
    ("calibradores: elegiveis", "3.4", r"all (\d+) have a published ephemeris", "3.4/calibradores_expandido",
     lambda v: str(v["n_elegiveis"])),
    ("calibradores: rendem epoca", "3.4", r"(\d+) yield a usable SuperWASP-era epoch", "3.4/calibradores_expandido",
     lambda v: str(v["n_rendem_epoca"])),
    ("calibradores: passam a guarda", "3.4", r"and (\d+) pass the between-season dispersion guard", "3.4/calibradores_expandido",
     lambda v: str(v["n_passam"])),
    ("calibradores: media IW22 (6)", "3.4", r"the weighted mean is ([−-]\d\.\d\d) ± \d\.\d\d min against the Ivshina",
     "3.4/calibradores_expandido", lambda v: f"{v['IW22']['media_min']:.2f}"),
    ("calibradores: barra IW22 (6)", "3.4", r"weighted mean is [−-]\d\.\d\d ± (\d\.\d\d) min against the Ivshina",
     "3.4/calibradores_expandido", lambda v: f"{v['IW22']['sigma_min']:.2f}"),
    ("calibradores: media ExoClock (6)", "3.4", r"and ([−-]\d\.\d\d) ± \d\.\d\d against\s+ExoClock III",
